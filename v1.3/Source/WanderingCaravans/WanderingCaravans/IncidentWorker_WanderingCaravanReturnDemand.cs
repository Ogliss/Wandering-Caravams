...
namespace WanderingCaravans
{
    public class IncidentWorker_WanderingCaravanReturnDemand : IncidentWorker
    {
        ...
        public override bool CanFireNowSub(IncidentParms parms) => WanderingCaravansUtility.SpawnedWanderingCaravansInMap((Map)parms.target).Any();

        public virtual IEnumerable<Pawn> SpawnPawns(PawnGroupMakerParms pawnGroupMakerParms, IntVec3 spawnCenter, Map map)
        {
